...
# Source files
SOURCES = main.c uri.c cache.c base64.c parser.c appstate.c settings.c threading.c ytdlp.c log.c ui.c dialogs.c memory.c error.c threadsafe.c subprocess_adapter.c
...
$(OBJ32_DIR)/subprocess_adapter.o $(OBJ64_DIR)/subprocess_adapter.o: subprocess_adapter.c YouTubeCacher.h threading.h ytdlp.h memory.h
